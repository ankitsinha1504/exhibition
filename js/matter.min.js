...
function runMatter() {
  ...
  Math.max(dimensions.width / 5, dimensions.height / 5) / 2,
  {
    render: {
      fillStyle: `rgb(217,255,195)`,
  ...
  for (var i = 0; i < 60; i += 1) {
    ...
    var circle = Bodies.circle(x, y, Common.random(2, 20), {
      ...
      frictionAir: 0,
      render: {
        fillStyle: r > 0.3 ? `#4aa96c` : `rgb(240,240,240)`,
        strokeStyle: `#3257E8`,
        lineWidth: 4 } });
